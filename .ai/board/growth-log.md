...
- **反映先**: `docs/agent/team.md` Shino節 / `docs/roadmap.md` Stage 3状態 / `.codex/agents/shino.toml` / `docs/work/current-task.md` / `docs/work/risk-review-stage3-shino-definition.md`
